...
from src.neg_pipeline import run_compact_practice, run_playbook_pipeline, run_practice_pipeline
...
if mode.startswith("🤝"):
    ...
    with tab_prac:
        ...
        st.write(
            ...
            "document** (sides, objectives, red lines, hidden pressures, facilitator note) "
            "you can print and rehearse with."
        )
