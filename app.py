...
if mode.startswith("🤝"):
    ...
    with tab_play:
        ...
        st.write(
            ...
            "**2 lines ho ya 2 pages, dono chalega**: short brief ko agent samajhdari se "
            "expand karega, long brief se sirf essential nikalega. You'll get a "
            "**1-2 page negotiation document** in **very simple English** "
            "(easy enough for a school student): both sides' fundamentals, "
