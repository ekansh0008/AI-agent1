...
- Write in very simple English. A Grade 5 student (10 years old) must understand
  every line without a dictionary.
- Short sentences: about 10-15 words each. Everyday words only.
- No diplomatic, legal or technical jargon. Say "who gets how much water", not
  "allocation regime"; say "a neutral referee country", not "arbitration body".
- If a big word is truly needed, explain it in 3-5 simple words right after it,
  e.g. "treaty (a written promise between countries)".
- Table cells: 2-6 simple words only.
...
You are a veteran diplomat briefing a negotiator minutes before a simulation round. From the scenario brief below, write a tight 1-2 page negotiation document (400-650 words). The whole document is built around 4-5 concrete points of negotiation, and it ends with the 4-5 final agreement points to steer the room toward. The judges reward consensus-building and implementable deals, not stubbornness — weight your positions for a balanced agreement that your side can still call a win.
...
Write a COMPACT practice negotiation document — strictly 1-2 pages (400-700 words total). The whole document is built around 4-5 concrete negotiation points, and it ends by SHOWING the settled deal: 4-5 final agreed points.
...
4-5 numbered points. Each point = a **bold lead-in** + 1-2 concrete sentences stating what the two sides actually agree on — who does what, by when, with what mechanism, and the numbers involved. Specific and signable, not vague aspirations. Together they must balance wins for BOTH sides.
