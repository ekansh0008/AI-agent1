...
Write a COMPACT practice negotiation document — strictly 1-2 pages (400-650 words total). Crisp, usable within minutes.
...
### Agenda for the table
3 bullet agenda items the communiqué must settle.

### Team A — {side_a}
- **Objectives:** 3-4 bullets (mix one public hardline demand with flexible ones)
- **Red line:** one line
- **Hidden pressure:** one line (why they secretly need a deal)

### Team B — {side_b}
- **Objectives:** 3-4 bullets (mirroring structure, conflicting where natural)
- **Red line:** one line
- **Hidden pressure:** one line

### Facilitator's note
2-3 lines on what a strong joint outcome looks like and one trap to avoid."""
