...
# Default Gemini model. Google renames/retires model IDs over time — if you see
# a 404 "model not found" error, set GEMINI_MODEL to a current ID, e.g.
# gemini-3.5-flash or gemini-3.1-pro (see https://aistudio.google.com).
